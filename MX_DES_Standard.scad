...
*/
mirror([0,0,0])keycap(
  keyID  = 52, //change profile refer to KeyParameters Struct
...
//    [17.16,  17.16,   6.5, 	 6.5, 10.0,    0,    0,    15,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //R4 8
    [17.16,  17.16,   6.5, 	 6.5, 8.75,    0,   .5,     8 ,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //R3 Home
    ...
    // 43~47
    [17.16,  17.16,   6.5, 	 6.5, 12.0,    0,   .5,     15,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //R3 Home
    [26.66,  17.16,   6.5, 	 6.5, 11.5,    0,    0,     20,     0,     8,   2,   2,      1,      5,      1,    3.5,     2,       2], // L shift
    [17.16,  17.16,   6.5, 	 6.5, 15,      0,    0,     25,     0,     10,   2,   2,      1,      5,      1,    3.5,     2,       2], //L layer shift
    [17.16,  36.26,   6.5, 	 6.5,10.00,    0,    0,     5,     12,     7.5,   2,   2,      1,      6,      1,    3.5,     2,       2], // ENT
    [17.16,  36.26,   6.5, 	 6.5,10.00,    0,    0,    5,     0,     0,   2,   2,      1,      6,      1,    3.5,     2,       2], //BSPACE
    
    // 48~52
    [17.16,  17.16,   6.5, 	 6.5, 14.0,    0,   .5,     -10,     0,     -5,   2,   2,      1,      5,      1,    3.5,     2,       2], //CMD
    [17.16,  17.16,   6.5, 	 6.5, 14.0,    0,   .5,     -10,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //alt/opt
    [17.16,  17.16,   6.5, 	 6.5, 11.5,    0,    0,    25,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //R5  
    [17.16,  17.16,   6.5, 	 6.5, 11.5,    0,    0,    25,     0,     15,   2,   2,      1,      5,      1,    3.5,     2,       2], //R5  c4
    [17.16,  17.16,   6.5, 	 6.5, 11.5,    0,    0,    25,     0,     -25,   2,   2,      1,      5,      1,    3.5,     2,       2], //R5  c5
];
